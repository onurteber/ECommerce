...
$.extend($.validator, {
	...
	messages: {
		...
		digits: "Lütfen Sadece Numara Girin.",
        creditcard: "Geçerli Bir Kredi Kartı numarası girin.",
		equalTo: "Lütfen Aynı Değeri Tekrar Giriniz.",
        accept: "Lütfen Geçerli Bir Uzantıya Sahip Bir Değer Girin.",
		maxlength: $.validator.format("Lütfen {0} Karakterden Fazla Girmeyin."),
		minlength: $.validator.format("Lütfen En Az {0} Karakter Girin.."),
		rangelength: $.validator.format("Lütfen {0} Ve {1} Karakterleri Arasında Değer Girin."),
        range: $.validator.format("Lütfen {0} ve {1} Arasında Bir Değer Girin ."),
        max: $.validator.format("Lütfen Değerinden Küçük Veya Daha Büyük Değer Girin{0}."),
		min: $.validator.format("Lütfen Değerine Eşit Veya Daha Büyük Değer Girin {0}.")
	},
